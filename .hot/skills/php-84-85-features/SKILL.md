---
name: php-84-85-features
description: Recursos novos do PHP 8.4 e 8.5 com exemplos práticos — property hooks, visibilidade assimétrica, pipe operator, clone with, novas funções de array, #[\NoDiscard], extensão URI nativa. Use esta skill quando o usuário pedir para escrever código PHP moderno, quiser saber recursos novos do PHP 8.4/8.5, perguntar sobre property hooks, pipe operator, visibilidade assimétrica, ou quando estiver revisando código PHP que pode se beneficiar de recursos novos.
---
